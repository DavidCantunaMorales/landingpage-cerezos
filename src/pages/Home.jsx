...
import Actividades from '../assets/Home/actividades_terapias.webp';
import Ambiente from '../assets/Home/ambiente_familiar.webp';
import Compromiso from '../assets/Home/compromiso_dedicacion.webp';
import Instalaciones from '../assets/Instalaciones/instalacion1.jpg';
import InstImage from '../assets/Instalaciones/instalacion5.jpg';
...
export const Home = () => {
  ...
  const images = [
    { src: Compromiso, title: 'Compromiso y dedicación' },
    { src: Instalaciones, title: 'Instalaciones Modernas' },
    { src: Actividades, title: 'Actividades y terapias' },
    { src: Ambiente, title: 'Ambiente familiar' },
  ];
        ...
        <div className='flex items-center justify-center md:justify-center p-4 sm:p-8'>
          <div className='flex flex-col gap-4 text-center'>
            ...
            <p className='text-gray-500 text-base sm:text-lg md:text-xl leading-6 text-justify my-4 sm:my-5'>
              ...
              Nos enfocamos por ofrecer una vida digna, llena de actividades
          ...
          <div className='relative'>
            ...
            >
              {testimonios.map((testimonio, index) => (
                <SwiperSlide key={index} className='text-center p-6'>
